...
from lib.losses.losses import *
from model.models.samplers import *
...
class DualBranchContrast(torch.nn.Module):
    ...
    def forward(self, h1=None, h2=None, g1=None, g2=None, g2_pos=None,batch=None, h3=None, h4=None,
        ...
        l1 = self.loss(anchor=anchor1, sample=sample1, sample_pos=None ,pos_mask=pos_mask1, neg_mask=neg_mask1, **self.kwargs)
        l2 = self.loss(anchor=anchor2, sample=sample2, sample_pos=None, pos_mask=pos_mask2, neg_mask=neg_mask2, **self.kwargs)
